# This code creates a lookup table where each product code is associated with a tuple containing the product name and its price. 
# This allows for efficient lookup of product information given a product code
...
# Generated result {'P1001': ('Apple', 1.2), 'P1002': ('Banana', 0.5), 'P1003': ('Cherry', 0.75), 'P1004': ('Date', 1.5)}
